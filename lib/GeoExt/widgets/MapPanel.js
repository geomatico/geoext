...
Ext.define('GeoExt.MapPanel', {
    ...
    initComponent: function(){
        ...
        // TODO: this.layers should be a Layer Store.
        if (!this.layers) {
    ...
    renderMap: function() {
        ...
        if (map.layers.length > 0) {
            ...
            // extjs4: changed event bind to OL.map,
            // because this.layers cannot handle events
            // TODO: Move event handling to the Layer Store.
            this.map.events.on({
                "addlayer": this.setInitialExtent,
                scope: this
            });
    ...
    afterLayout: function() {
        ...
        if (width > 0 && height > 0 && this.ownerCt) {
...
GeoExt.MapPanel.guess = function() {
    return Ext.ComponentQuery.query('gx_mappanel')[0];
};
